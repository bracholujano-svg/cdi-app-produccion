...
const ReportPreviewModal = () => {
                                ...
                                <div>
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <div className="flex gap-2 mt-1">
                                            <span className="text-sm font-mono font-bold bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400 px-1.5 py-0.5 rounded border border-red-200 dark:border-red-800/50">OC: {item.orderOC}</span>
                                            <span className="text-sm font-mono font-bold bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400 px-1.5 py-0.5 rounded border border-blue-200 dark:border-blue-800/50">ART: {item.codArticulo}</span>
                                        </div>
                                    </div>
  ...
  const printTarget = document.getElementById('print-root');
  ...
  return (
    <>
      ...
      {printTarget && ReactDOM.createPortal(reportBody, printTarget)}
    </>
  );
};
