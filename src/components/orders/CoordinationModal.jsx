            ...
            <div className="p-5 overflow-y-auto custom-scrollbar flex-1 space-y-5">
              ...
              {coordList.length > 0 && (
                <div className="space-y-3">
                  ...
                  <button type="button" onClick={saveBatchCoordination} className="w-full bg-[var(--color-primary)] text-[var(--color-surface)] py-4 rounded-xl font-black uppercase text-base lg:text-lg shadow-sm border border-[var(--color-border)] transition-colors duration-200 hover:brightness-125 active:scale-95 mt-4 disabled:opacity-50">Confirmar y Guardar Alertas</button>
                </div>
              )}
            </div>
          </div>
