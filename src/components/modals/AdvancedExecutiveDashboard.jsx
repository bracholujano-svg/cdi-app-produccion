                    ...
                    {dashboardTab === 'resumen' && (
                        <section className="space-y-8 animate-in fade-in duration-500">
                            <div className="theme-bg-card p-8 rounded-[2.5rem] shadow-sm border theme-border flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                                <div>
                                    <h1 className="text-3xl font-black theme-text-main uppercase tracking-tight" style={{ fontFamily: "\"Space Grotesk\", sans-serif" }}>Estado de Planta Actual</h1>
                                        ...
                                        {tableOrders.map(o => (
                                            <tr key={o.id} className="border-b theme-border hover:theme-bg-card/50 transition-colors">
                                                ...
                                                <td className="p-5 text-center">
                                                    <button type="button" onClick={() => setHistoryOrder(o)} className="bg-[var(--color-primary)] text-[var(--color-base)] px-4 py-2 rounded-xl font-black text-sm md:text-base uppercase hover:brightness-110 active:scale-95 transition-all flex items-center gap-1 mx-auto shadow-sm">
                                ...
                                <div className="flex-1 space-y-4">
                                    <div className="bg-slate-800 p-4 rounded-2xl border border-slate-700 shadow-xl text-white flex justify-between items-center">
                                        ...
                                        <div className="text-right">
                                            ...
                                            <p className="text-sm md:text-base lg:text-sm text-slate-400 font-bold uppercase mt-1">{totalInspeccionesRealizadas} actas totales</p>
                                        </div>
                                    </div>
